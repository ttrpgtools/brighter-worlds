...
<main class="p-8 flex flex-col items-center justify-center gap-2 min-h-screen">
  <h2 class="font-title text-4xl">Welcome to</h2>
  <h1 class="font-title text-6xl"><a href="https://brighterworldsrpg.com" class="text-purple-700 dark:text-purple-300">Brighter Worlds</a></h1>
