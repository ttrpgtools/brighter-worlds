...
<div class="max-w-prose prose dark:prose-invert prose-lg text-left mb-6">
  <p>
    Attributes represent both a character's prowess and current status. All three of your Attributes
    start at a <Die which={4} /> d4. Step up one Attribute twice (to a <Die which={8} /> d8), and another
    Attribute once (to a <Die which={6} /> d6).
  </p>
...
<div class="max-w-prose prose dark:prose-invert prose-lg text-left mb-6">
  <p>
    Grit is a character's mental concentration and ability to avoid being harmed. It represents a
    combination of reflexes and situational awareness.
  </p>
  <p>
    Grit is lost when being attacked, performing complex tasks like casting Spells, or attempting to
    carry too much. It is not a measure of physical health, and lost Grit is restored quickly.
  </p>
