...
<h3 class="max-w-prose text-center mb-4 text-lg">Choose your starting attributes</h3>
<p class="max-w-prose text-center mb-6">Assign one each of a d4, d6 and d8.</p>
