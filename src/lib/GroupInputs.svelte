    ...
    {#each options as opt (opt.name)}
      {#if !hideUnavailable || !onlyDeselect || selection.has(opt.name)}
        <div class="relative">
          ...
          <label
            for={`${baseId}-${opt.name}`}
            class="[&_.desc]:text-gray-600 dark:[&_.desc]:text-gray-400 peer-checked:[&_.desc]:text-purple-200 dark:peer-checked:[&_.desc]:text-purple-800 peer-disabled:cursor-not-allowed peer-disabled:text-gray-500 peer-focus:ring-2 peer-focus:ring-purple-500/60 peer-focus:ring-offset-white dark:peer-focus:ring-offset-gray-900 peer-focus:ring-offset-2 hover:ring-2 hover:ring-purple-500/60 hover:ring-offset-white dark:hover:ring-offset-gray-900 hover:ring-offset-2 bg-white dark:bg-gray-900 relative flex cursor-pointer rounded-lg px-5 py-4 shadow-lg dark:shadow-purple-400/20 focus:outline-none peer-checked:bg-purple-800/75 peer-checked:text-white dark:peer-checked:bg-purple-300/75 dark:peer-checked:text-gray-900"
          >
