...
<div>
  <div class="relative mt-1">
    <input {placeholder} use:combobox.input on:select type="text" class="w-full rounded-full dark:bg-gray-900 dark:text-white focus:ring-purple-500 focus:border-purple-500" bind:value={textValue}>
