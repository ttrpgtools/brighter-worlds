<script lang="ts">
  ...
  let damageDialog: InputDialog<DamageForm> | undefined = $state();
  const damageForm: DamageForm = $state({
    damage: '',
    bypassGrit: false,
    bypassArmor: false,
    overflow: true,
...
<InputDialog
  title="How much potential {saveType} damage?"
  dice={[]}
  bind:this={damageDialog}
  form={damageForm}
>
