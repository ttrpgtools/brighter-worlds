  ...
  <form class="text-center flex flex-col gap-3">
    ...
    <div>
      <span class="isolate inline-flex rounded-md shadow-sm">
        <button type="button" aria-selected={damageForm.type === 'str'} on:click={() => damageForm.type = 'str'} class="relative inline-flex items-center rounded-l-md bg-purple-300 dark:bg-purple-700 dark:aria-selected:bg-purple-300 aria-selected:bg-purple-700 aria-selected:text-white dark:aria-selected:text-gray-800 dark:ring-purple-300 ring-purple-700 px-3 py-2 text-sm font-semibold ring-1 ring-inset hover:bg-purple-200 dark:hover:bg-purple-800 focus:z-10 focus:ring-offset-white dark:focus:ring-offset-gray-900 focus:ring-purple-500 focus:outline-none">STR</button>
        <button type="button" aria-selected={damageForm.type === 'dex'} on:click={() => damageForm.type = 'dex'} class="relative -ml-px inline-flex items-center bg-purple-300 dark:bg-purple-700 dark:aria-selected:bg-purple-300 aria-selected:bg-purple-700 aria-selected:text-white dark:aria-selected:text-gray-800 dark:ring-purple-300 ring-purple-700 px-3 py-2 text-sm font-semibold ring-1 ring-inset hover:bg-purple-200 dark:hover:bg-purple-800 focus:z-10 focus:ring-offset-white dark:focus:ring-offset-gray-900 focus:ring-purple-500 focus:outline-none">DEX</button>
        <button type="button" aria-selected={damageForm.type === 'wil'} on:click={() => damageForm.type = 'wil'} class="relative -ml-px inline-flex items-center rounded-r-md bg-purple-300 dark:bg-purple-700 dark:aria-selected:bg-purple-300 aria-selected:bg-purple-700 aria-selected:text-white dark:aria-selected:text-gray-800 dark:ring-purple-300 ring-purple-700 px-3 py-2 text-sm font-semibold ring-1 ring-inset hover:bg-purple-200 dark:hover:bg-purple-800 focus:z-10 focus:ring-offset-white dark:focus:ring-offset-gray-900 focus:ring-purple-500 focus:outline-none">WIL</button>
      </span>
    </div>
    {/if}
