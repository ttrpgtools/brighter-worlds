...
const gear = {
  ...
  str: {
    ...equipment.str,
    items: equipment.str.items.map((e) => ({ id: id(), ...e, bulky: e.bulky ?? false }) as Item),
  },
  dex: {
    ...equipment.dex,
    items: equipment.dex.items.map((e) => ({ id: id(), ...e, bulky: false }) as Item),
  },
  wil: {
    ...equipment.wil,
    items: equipment.wil.items.map((e) => ({ id: id(), ...e, bulky: false }) as Item),
  },
} as StartingGear;
